...
<header>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item ms-5">
                                    <a class="btn btn-danger nav-link active  text-white fw-bold" aria-current="page" href="cerrar.php">Cerrar sesión </a>
                                </li>
                                <li class="nav-item ms-5">
                                    <a class="btn btn-warning nav-link active  fw-bold" href="../vistas/posts.php">Tus publicaciones</a>
                                </li>
    ...
    <div class="container  ">
        <div class="row">
            <h2 class="mt-3 text-primary">Actualice sus promociones publicaciones o lo que necesite por epocas :)</h2>
        ...
        <p class="fs-3 fw-bold"> Para una calidad adecuada en las imagenes use las siguientes dimensiones: 1280px o 1300px de ancho por 720px de alto :) </p>
