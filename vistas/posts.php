...
<body class="fondo4 mt-5   " >
  <script src="code.js"></script>
  <header>
    <!--------------------------------------nav style="background-color: #0a1c26 ;"----------------------------->
    <!--animate css-->
    <nav class="navbar  fixed-top navbar-expand-lg bg-light fondo12">
      <div class="container-fluid">
        <img src="../imagenes/logo5.png" class=" d-inline-block align-text-top" alt="..." />
        ...
        <div class="col-3 ms-4 bg-warning"></div>
